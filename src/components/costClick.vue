        ...
        methods: {
            ...
            abc(){
                ...
                this.datass=[
                    ...
                    ['渠道A', 31.1, 20.4, 60.1, 33.3, 73.8, 78.7,23.2],
                    ['渠道B', 36.5, 82.1, 15.7, 43.1, 23.4, 35.1,76.1],
                    ['渠道C', 74.1, 57.2, 39.5, 66.4, 45.2, 82.5,27.8],
                    ['渠道D', 55.2, 47.1, 79.2, 42.4, 23.9, 39.1,40.5],
                ]
